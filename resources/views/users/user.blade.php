...
<div class="content-wrapper" style="padding-top:1%;">
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-2">
                    <!-- Include the addFile.blade.php content here -->
                    @include('menu/addFile') <!-- Replace with actual path -->
                </div>
                <div class="col-md-10">
                                    ...
                                    <table id="example1" class="table table-hover table-sm text-sm">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><p class="badge badge-warning" style="font-size: 9px;">{{ $user->role }}</p></td>
                                                <td>{{ $user->updated_at }}</td>
                                                <td>

                                                    <div class="btn-group w-100">
                                                        <a href="{{ route('userEdit', $user->id) }}" class="btn btn-primary" style="text-decoration: none; color: white;">
        <i class="fas fa-pen"></i>
                                                        ...
                                                        {{-- <form action="{{ route('users.deleteUser', $user->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                                            ...
                                                            @method('DELETE') --}}
                                                            <a href="javascript:void(0);" onclick="deleteUser('{{ route('users.deleteUser', $user->id) }}')" class="btn btn-danger no-left-radius">

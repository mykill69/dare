...
<div class="content-wrapper">
	...
	<section class="content">
		<div class="container-fluid">
			<h2 class="text-center text-xlg" style="font-family: Helvetica;">Welcome to CPSU - DARE! <br>Feel free to search for your research references.</h2>
			<div class="row">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												...
												<a href="{{ route('viewPdf', $result->id) }}" target="_blank">
													{{ pathinfo($result->file_name, PATHINFO_FILENAME) }}
												</a>
											</td>
											<td>{{ $result->user_id }}</td>
											<td>{{ $result->folder->folder_category ?? 'No Category' }}</td>
